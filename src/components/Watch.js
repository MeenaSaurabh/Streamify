  ...
  return (
    <div>
      <div className="bg-black h-screen ">
        <Link to={"/browse"}>
          <button className="absolute z-20 bg-black bg-opacity-40 text-lg text-white p-2 rounded-sm w-20 top-3  left-2 sm:top-20 sm:left-10 hover:bg-white hover:text-black">
            Back
          </button>
        </Link>
